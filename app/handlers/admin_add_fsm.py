...
async def set_admin(
    ...
    await query.message.edit_text(
        text=msg["add_admin"]["create_greet_adm"], parse_mode="HTML"
    )
    data = {}
...
async def set_admin_accept_message(
    ...
    if (
        ...
        text = await i_add_admin(user_object=user, register=admin_unit, msg=msg)
